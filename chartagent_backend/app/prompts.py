    ...
    return "\n".join(
        [
            ...
            *market_context,
            ...
            "Lead with a decisive call in consensus.title, consensus.summary, and every agent thesis: state buy-side, sell-side, or wait first, then give the exact chart condition that supports it.",
            "Do not dilute a supported call with stacked hedges such as 'may, might, possibly' repeated in one opinion. If evidence is insufficient, say WAIT plainly and name the single next confirmation trigger.",
